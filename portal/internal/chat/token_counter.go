...
var tokenCounters = fwctx.NewTokenCounterRegistry()
...
func TokenCounterFor(provider, modelName string) fwctx.TokenCounter {
...
func TokenCounterStats() map[string]fwctx.TokenCounterStats {
