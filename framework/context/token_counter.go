...
func (c *ConservativeCounter) Count(msgs []model.Message) int {
...
func (c *CalibratedCounter) Count(msgs []model.Message) int {
	return EstimateTokensConservative(msgs, c.Alpha())
}
...
func ObserveTokenUsage(counter TokenCounter, msgs []model.Message, gen *model.Generation) {
