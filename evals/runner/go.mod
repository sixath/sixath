module github.com/sixath/evals/runner

// mock/live 驱动 import framework 的 agent/model/tool，故升到 go 1.26 并 replace 本地 framework。
// 传递依赖与 go.sum 复用 framework/portal（离线环境无法 go mod tidy 解析工具链）。
go 1.26

require github.com/sixath/framework v0.0.3

replace github.com/sixath/framework => ../../framework
