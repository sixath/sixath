...
func NewAgentService(uc *biz.AgentUsecase, toolUC *biz.ToolUsecase, skillUC *biz.SkillResourceUsecase, channelUC *biz.ChannelUsecase, logger log.Logger) *AgentService {
	return &AgentService{uc: uc, toolUC: toolUC, skillUC: skillUC, channelUC: channelUC, log: log.NewHelper(logger)}
}
